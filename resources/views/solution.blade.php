        ...
        <div class="ml-auto self-center">
            <form class="border shadow-md rounded w-5/6 mx-auto px-7 py-12">
                ...
                <div class="w-11/12 mx-auto">
                    <input class="w-full mx-auto px-4 md:px-5 py-2 my-3 border-gray-200 rounded-md bg-yellow-100 focus:outline-none focus:border-gray-300 focus:ring-0 focus:bg-yellow-50" type="text" name="" id="" placeholder="Your Name">
