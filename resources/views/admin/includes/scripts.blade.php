<!--**********************************
    ...
    ***********************************-->
    ...
    <!-- Datamap -->
    <script src="admins/plugins/d3v3/index.js"></script>
    <script src="admins/plugins/topojson/topojson.min.js"></script>
    <script src="admins/plugins/datamaps/datamaps.world.min.js"></script>
    <!-- Morrisjs -->
